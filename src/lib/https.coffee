...
module.exports = (dnschain) ->
    ...
    fPromise = pem.certFingerprint(httpSettings.tlsCert).then (f) ->
        ...
        start: ->
            @startCheck (cb) =>
                ...
                if httpsVars.tls.then
                    Promise.join(fPromise, httpsVars.tls).then =>
                        tlsOptions =
                            key: fs.readFileSync httpSettings.tlsKey
                            cert: fs.readFileSync httpSettings.tlsCert

                        httpsVars.tls = tls.createServer tlsOptions, (c) =>
                        ...
                        httpsVars.tls.on "error", (err) -> tlsLog.error err
