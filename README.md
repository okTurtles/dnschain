...
- [Free SSL certificates](#Free)
- [How to use DNSChain _\*right now\*!_](#How)
    - [Don't want to change your DNS settings?](#Don't)
- [The '.dns' meta-TLD](#The)
- [How to run your own DNSChain server](#How)
    - [Requirements](#Requirements)
    - [Getting Started for devs and sys admins](#Getting)
- [List of public DNSChain servers](#List)
- [Contributing](#Contributing)
    - [Style and Process](#Style)
- [TODO](#TODO)
...
## Free SSL certificates<a name="Free"/>
...
## How to use DNSChain _\*right now\*!_<a name="How"/>
...
#### Don't want to change your DNS settings?<a name="Don't"/>
...
## How to run your own DNSChain server<a name="How"/>
...
### Getting Started for devs and sys admins<a name="Getting"/>

This section __to-be-finished__!

For now I'll quickly note the basic idea, which is standard NodeJS development:

1. Get `namecoind` running in the background
2. Clone this repo
3. Run `npm install` inside of the cloned repo.
4. Run test server with `sudo grunt example`
...
You can also run the `dnschain` binary in the bin folder.
...
<a name="servers"></a>
## List of public DNSChain servers<a name="List"/>

**NOTE:** *DNSChain is meant to be run by individuals!*
...
We'll list the public keys for these servers here as well when the signing of responses is implementing. Note that for *ENCRYPTED* servers you are already guaranteed the authenticity of responses.
...
#### Style and Process<a name="Style"/>
